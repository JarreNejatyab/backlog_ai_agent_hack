...
{
    /// <summary>
    /// Plugin for searching backlog creation and grooming in Azure AI Search
    /// </summary>
public class BacklogKnowledgePlugin
{
    private readonly Kernel _kernel;
    private readonly string _collectionName;

    public BacklogKnowledgePlugin(Kernel kernel, string collectionName )
    {
        _kernel = kernel;
    ...
    [Description("Search for backlog creation and grooming in a knowledge base")]
